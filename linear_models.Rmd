...
Let's change the reference category. (Can do this by piping in the data!)
...
Interactions...? 
(You need interactions to test. Can't test by fitting a model within each borough separately)
```{r}
fit = 
  nyc_airbnb %>% 
